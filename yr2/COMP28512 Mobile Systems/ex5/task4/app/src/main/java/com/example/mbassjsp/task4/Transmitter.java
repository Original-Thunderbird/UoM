...
public class Transmitter extends Thread{
    ...
    private int flag,i,j;
    private String prefix,fragment,body;

    //Class constructor
    public Transmitter( PrintWriter printerRef, String transmitterString, int flag)
    {
    ...
    //public static void setTransmitterString(St)
}
